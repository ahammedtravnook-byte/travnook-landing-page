  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tooltip */}
        <div className="absolute right-20 bg-white text-gray-800 text-sm font-bold px-4 py-2 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
          Chat With Us
